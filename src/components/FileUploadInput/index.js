...
const FileUploadInput = (props) => {
    ...
    return ( 
        <fieldset className="flex cursor-pointer relative mb-5 z-0">
            ...
            <input className="absolute opacity-0 w-full h-16 z-50 cursor-pointer rounded-lrg" type="file" onChange={(e) => handleUpload(e)} accept=".jpg, .jpeg, .png" name={name}/>
            <label className="w-full h-100 flex z-0 gap-2 rounded-md border border-gray-300 hover:border-primary p-3">
